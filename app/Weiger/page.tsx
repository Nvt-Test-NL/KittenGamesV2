  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <main className="container mx-auto px-4 py-8 pt-24 max-w-4xl">
        <h1 className="text-3xl font-bold text-white mb-6">Weigering Privacyverklaring Pjotter-AI</h1>

        <p className="text-gray-300 mb-6">
          Weigeren om persoonsgegevens te verwerken is een persoonlijke keuze die je kunt maken. Deze privacyverklaring beschrijft hoe Pjotter-AI (onderdeel van Pjotters-Company) persoonsgegevens verwerkt in overeenstemming met de AVG (EU) en de Nederlandse wetgeving. Deze verklaring is bedoeld als basis en kan door jou verder worden aangevuld.
        </p>
